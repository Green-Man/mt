...
fig.\ref{fig:both_set}. The path traced reference images are shown on the left.
\begin{figure}[h]
    \centering
    \begin{subfigure}{0.48\textwidth}
...
In this section we present the generalized results of the measurements described in two previous
sections.
...
\begin{figure}[h]
    \includegraphics[width=\textwidth]{plots/matrix_isocontours}
